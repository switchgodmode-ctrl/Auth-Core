    ...
    <div className="dash-shell">
      ...
      <aside className={`dash-sidebar ${sidebarOpen ? "open" : ""}`}>
        ...
        <nav className="dash-nav" style={{ flex: 1 }}>
          {!isAdmin ? (
            ...
            <>
              ...
              <NavLink to="/admin/users" onClick={() => setSidebarOpen(false)} className={({ isActive }) => isActive ? "active" : ""}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                User Management
              </NavLink>
              <NavLink to="/admin/security" onClick={() => setSidebarOpen(false)} className={({ isActive }) => isActive ? "active" : ""}>
        ...
        <div style={{ padding: '12px 24px', fontSize: '0.65rem', color: 'var(--muted)', textAlign: 'center', opacity: 0.5 }}>
           AuthCore Admin Suite v2.2.0 (Stable)
        </div>
