      ...
      _heartbeatTimer = new Timer(async _ => {
        try {
          ...
          if (root.TryGetProperty("status", out var statusEl) && statusEl.GetBoolean() &&
              root.TryGetProperty("active", out var activeEl) && !activeEl.GetBoolean() &&
              root.TryGetProperty("currentStatus", out var currentStatusEl) && currentStatusEl.GetString() == "killed") {
